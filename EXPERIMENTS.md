...
- **다음(진행 중)**: 회전 4배 증강(방향 정확히 25% 씩, 방향 불변성 강제) 42,048 행 1 epoch, 23:17 KST 시작. 이후
  1→2→3수 커리큘럼, 맵 수 늘리기, 그리고 관리자가 준 원본 과제(navigation / local_safety / one_step_probability)를 따로.
